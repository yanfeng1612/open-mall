    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>商品品牌表管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                requestData({
                    "url": "/api/open-mall-product/productBrand/list?pageSize=" + self.pageInfo.pageSize + "&pageNo=" + self.pageInfo.curPage,
            ...
            toAdd() {
                this.$router.push({path: '/productBrandEdit'});
            },
            toEdit(index, row) {
                const item = this.tableData[index];
                this.$router.push({path: '/productBrandEdit', query: {id : item.id}, meta: {title: "edit"}});
            },
            toDetail(index, row) {
                const item = this.tableData[index];
                this.$router.push({path: '/productBrandDetail', query: {id : item.id}, meta: {title: "edit"}});
            },
            search() {
