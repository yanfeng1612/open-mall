    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>商品分类表管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                    ...
                    <el-input v-model="searchData.query.description" placeholder="分类描述" class="handle-input mr10"></el-input>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                requestData({
                    "url": "/api/open-mall-product/productCategory/list?pageSize=" + self.pageInfo.pageSize + "&pageNo=" + self.pageInfo.curPage,
            ...
            toAdd() {
                this.$router.push({path: '/productCategoryEdit'});
            },
            toEdit(index, row) {
                const item = this.tableData[index];
                this.$router.push({path: '/productCategoryEdit', query: {id : item.id}, meta: {title: "edit"}});
            },
            toDetail(index, row) {
                const item = this.tableData[index];
                this.$router.push({path: '/productCategoryDetail', query: {id : item.id}, meta: {title: "edit"}});
            },
            search() {
