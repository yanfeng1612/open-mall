    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>订单购物车管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                    ...
                    <el-input v-model="searchData.query.productCount" placeholder="数量" class="handle-input mr10"></el-input>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                requestData({
                    "url": "/api/orderCart/list?pageSize=" + self.pageInfo.pageSize + "&pageNo=" + self.pageInfo.curPage,
            ...
            toAdd() {
                this.$router.push({path: '/orderCartEdit'});
            },
            toEdit(index, row) {
                const item = this.tableData[index];
                this.$router.push({path: '/orderCartEdit', query: {id : item.id}, meta: {title: "edit"}});
            },
            toDetail(index, row) {
                const item = this.tableData[index];
                this.$router.push({path: '/orderCartDetail', query: {id : item.id}, meta: {title: "edit"}});
            },
            search() {
